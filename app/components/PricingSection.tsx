			...
			<div className='grid gap-8 md:grid-cols-2'>
				<Card className='w-full max-w-md bg-(--white-text)'>
					<CardHeader>
						...
						<CardDescription>The essential tools and filters to generate SaaS ideas.</CardDescription>
					</CardHeader>
					<CardContent>
						<h3 className='flex justify-start items-end gap-1 text-5xl font-extrabold'>
							<span className='text-lg text-gray-500 font-[600] line-through'>$35</span>
							<span>$15</span>
						...
						<ul className='mt-8 space-y-3 text-xl'>
							<li className="relative pl-6 text-sm before:content-['✓']  before:absolute before:left-0 before:text-(--pink-text) before:font-bold opacity-75">
								<span className='text-(--dark-text)'>5 idea generations per day</span>
							</li>
							<li className="relative pl-6 text-sm before:content-['✓']  before:absolute before:left-0 before:text-(--pink-text) before:font-bold opacity-75">
							...
							<li className="relative pl-6 text-sm before:content-['x'] before:absolute before:left-0 before:text-(--dark-text) before:font-bold opacity-50">
								<span className='text-(--dark-text)'>ChatGPT Prompts for coding generated ideas</span>
							</li>
							<li className="relative pl-6 text-sm before:content-['x'] before:absolute before:left-0 before:text-(--dark-text) before:font-bold opacity-50">
								<span className='text-(--dark-text)'>Step-by-step guide for coding ideas</span>
							</li>
							<li className="relative pl-6 text-sm before:content-['x'] before:absolute before:left-0 before:text-(--dark-text) before:font-bold opacity-50">
					...
					<CardFooter className='flex flex-col gap-3'>
						...
						<p className='text-xs text-(--dark-text) opacity-75'>Pay once. Acces forever.</p>
					</CardFooter>
				</Card>
				...
				<Card className='w-full max-w-md bg-(--white-text)'>
					...
					<CardContent>
						<h3 className='flex justify-start items-end gap-1 text-5xl font-extrabold'>
							<span className='text-lg text-gray-500 font-[600] line-through'>$100</span>
							<span>$49</span>
							<span className='text-base font-[600]'>USD</span>
						</h3>
						...
						<ul className='mt-8 space-y-3 text-xl'>
							<li className="relative pl-6 text-sm before:content-['✓']  before:absolute before:left-0 before:text-(--pink-text) before:font-bold opacity-75">
								<span className='text-(--dark-text)'>Unlimited idea generations</span>
							</li>
							<li className="relative pl-6 text-sm before:content-['✓']  before:absolute before:left-0 before:text-(--pink-text) before:font-bold opacity-75">
								<span className='text-(--dark-text)'>All categories</span>
							</li>
